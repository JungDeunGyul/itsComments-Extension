...
function App() {
  ...
  return (
    <main className="w-80 h-50 bg-gradient-to-b from-gray-700 via-gray-900 to-gray-800">
      {loading ? (
        <div className="flex flex-col items-center justify-center h-full">
          <div className="w-32 h-32 border-t-8 border-red-300 rounded-full animate-spin"></div>
